pragma solidity ^0.4.25;
 ...
 /**
 * XRC-20 token 451PCBcom (PCB)
 * Coded by 451PCB.COM (2020)
 */
...
contract PCB {
  ...
  string public tokenName = '451PCBcom';
  string public tokenSymbol = 'PCB';
  uint256 public mintCap = 100000000000000;
  ...
  function withdrawIOTX() public returns (bool){
    require(owner == msg.sender);
    msg.sender.transfer(address(this).balance);
    return true;
  }
  
  function withdrawXRC20(address _tokenContract) public returns (bool){
    require(owner == msg.sender);
    require(_tokenContract != address(0));
    XRC20Token token = XRC20Token(_tokenContract);
